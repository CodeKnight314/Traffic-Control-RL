...
python main.py --config config.yaml --net routes/4x4loop/4x4loop.net.xml --route routes/4x4loop/4x4loop.rou.xml --path 4x4loop/weights/ --train --weights ../resources/weights/base_policy_weights.pth
