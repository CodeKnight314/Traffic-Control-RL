...
python main.py --config config.yaml --net routes/2x2grid/2x2.net.xml --route routes/2x2grid/2x2.rou.xml --path 2x2grid/weights/ --train --weights ../resources/weights/base_policy_weights.pth
